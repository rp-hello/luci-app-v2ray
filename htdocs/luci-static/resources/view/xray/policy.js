...
return L.view.extend({
    ...
    render: function(e) {
        void 0 === e && (e = []);
        var o, n = new form.Map("luci_xray", "%s - %s".format(_("Xray"), _("Policy")), _("Details: %s").format('<a href="https://www.v2fly.org/config/policy.html#policyobject" target="_blank">PolicyObject</a>')), l = n.section(form.NamedSection, "main_policy", "policy");
