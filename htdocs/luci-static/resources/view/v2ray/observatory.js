...
return L.view.extend({
    render: function() {
        var e = new form.Map("luci_xray", "%s - %s".format(_("Xray"), _("Observatory")), _("Details: %s").format('<a href="https://www.v2fly.org/config/observatory.html#observatoryobject" target="_blank">ObservatoryObject</a>')), r = e.section(form.NamedSection, "main_observatory", "observatory");
